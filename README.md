...
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,744 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - The Kubernetes Goat designed to be intentionally vulnerable cluster environment to learn and practice Kubernetes security.
...
* [VAmPI](https://github.com/erev0s/VAmPI) ⭐ 1,278 | 🐛 4 | 🌐 Python | 📅 2026-04-07 - VAmPI is a vulnerable API made with Flask and it includes vulnerabilities from the OWASP top 10 vulnerabilities for APIs.
