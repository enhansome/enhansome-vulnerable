...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 499,861 | 🐛 106 | 📅 2026-08-21
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,715 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-24 - An Open Source platform for testing Web-Application Security skills. The application contains a vast number of hacking challenges of varying difficulty level
* [OWASP WebGoat8](https://github.com/webgoat/webgoat) ⭐ 9,291 | 🐛 39 | 🌐 JavaScript | 📅 2026-08-24 - OWASP Webgoat 8 is a learning platform that attempts to teach about common web security flaws. It contains generic security flaws that apply to most web applications, is written in Java and is actively maintained.
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat.git) ⭐ 3,705 | 🐛 24 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
...
* [Unguard](https://github.com/dynatrace-oss/unguard) ⭐ 73 | 🐛 19 | 🌐 TypeScript | 📅 2026-05-28 - An insecure cloud-native microservices demo application for Kubernetes. Unguard includes vulnerable Java, .NET, Node.js, Go, and PHP services, MariaDB and Redis databases, an Envoy proxy, and a load generator.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,802 | 🐛 426 | 🌐 Python | 📅 2026-08-19 - CTFs as you need them
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,754 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - The Kubernetes Goat designed to be intentionally vulnerable cluster environment to learn and practice Kubernetes security.
...
* [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,134 | 🐛 233 | 🌐 Python | 📅 2026-08-14 - A set of mobile apps that help you to improve your reverse engineering skills base don the [OWASP MSTG](https://github.com/OWASP/owasp-mstg) ⭐ 13,134 | 🐛 233 | 🌐 Python | 📅 2026-08-14.
...
* [dvws-node](https://github.com/snoopysecurity/dvws-node) ⭐ 516 | 🐛 4 | 🌐 JavaScript | 📅 2026-03-29 - Damn Vulnerable Web Services is a vulnerable application with a web service and an API that can be used to learn about webservices/API related vulnerabilities.
