...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,469 | 🐛 106 | 📅 2026-09-02
...
[![GitHub stars](https://img.shields.io/github/stars/kaiiyer/awesome-vulnerable)](https://github.com/kaiiyer/awesome-vulnerable/stargazers) ⭐ 1,393 | 🐛 2 | 📅 2026-06-22
[![GitHub issues](https://img.shields.io/github/issues/kaiiyer/awesome-vulnerable.svg)](https://GitHub.com/kaiiyer/awesome-vulnerable/issues/) ⭐ 1,393 | 🐛 2 | 📅 2026-06-22
[![GitHub pull-requests](https://img.shields.io/github/issues-pr/kaiiyer/awesome-vulnerable.svg)](https://GitHub.com/kaiiyer/awesome-vulnerable/pull/) ⭐ 1,393 | 🐛 2 | 📅 2026-06-22
[![GitHub contributors](https://img.shields.io/github/contributors/kaiiyer/awesome-vulnerable.svg)](https://GitHub.com/kaiiyer/awesome-vulnerable/graphs/contributors/) ⭐ 1,393 | 🐛 2 | 📅 2026-06-22
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,892 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-18 - An Open Source platform for testing Web-Application Security skills. The application contains a vast number of hacking challenges of varying difficulty level
* [OWASP WebGoat8](https://github.com/webgoat/webgoat) ⭐ 9,342 | 🐛 38 | 🌐 JavaScript | 📅 2026-09-17 - OWASP Webgoat 8 is a learning platform that attempts to teach about common web security flaws. It contains generic security flaws that apply to most web applications, is written in Java and is actively maintained.
...
* [NOWASP / Mutillidae 2](https://github.com/webpwnized/mutillidae) ⭐ 1,523 | 🐛 1 | 🌐 PHP | 📅 2026-06-22 - OWASP Mutillidae II is a free, open source, deliberately vulnerable web-application providing a target for web-security enthusiast.
...
* [VulnLab](https://github.com/Yavuzlar/VulnLab) ⭐ 530 | 🐛 5 | 🌐 CSS | 📅 2025-02-02 - A vulnerable web application lab using Docker
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 45 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-17 - An open-source, intentionally vulnerable e-commerce application built with Next.js and React. Provides a realistic CTF platform for learning web application security testing. Can be quickly set up using `npx create-oss-store`.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,841 | 🐛 427 | 🌐 Python | 📅 2026-09-17 - CTFs as you need them
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,788 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - The Kubernetes Goat designed to be intentionally vulnerable cluster environment to learn and practice Kubernetes security.
...
* [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,185 | 🐛 240 | 🌐 Python | 📅 2026-09-18 - A set of mobile apps that help you to improve your reverse engineering skills base don the [OWASP MSTG](https://github.com/OWASP/owasp-mstg) ⭐ 13,185 | 🐛 240 | 🌐 Python | 📅 2026-09-18.
...
* [Allsafe](https://github.com/t0thkr1s/allsafe) ⭐ 433 | 🐛 2 | 🌐 Java | 📅 2025-09-20 - Allsafe is an intentionally vulnerable application that contains various vulnerabilities.
...
* [VAmPI](https://github.com/erev0s/VAmPI) ⭐ 1,327 | 🐛 4 | 🌐 Python | 📅 2026-04-07 - VAmPI is a vulnerable API made with Flask and it includes vulnerabilities from the OWASP top 10 vulnerabilities for APIs.
