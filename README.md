...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 506,712 | 🐛 106 | 📅 2026-09-02
...
[![GitHub stars](https://img.shields.io/github/stars/kaiiyer/awesome-vulnerable)](https://github.com/kaiiyer/awesome-vulnerable/stargazers) ⭐ 1,392 | 🐛 2 | 📅 2026-06-22
[![GitHub issues](https://img.shields.io/github/issues/kaiiyer/awesome-vulnerable.svg)](https://GitHub.com/kaiiyer/awesome-vulnerable/issues/) ⭐ 1,392 | 🐛 2 | 📅 2026-06-22
[![GitHub pull-requests](https://img.shields.io/github/issues-pr/kaiiyer/awesome-vulnerable.svg)](https://GitHub.com/kaiiyer/awesome-vulnerable/pull/) ⭐ 1,392 | 🐛 2 | 📅 2026-06-22
[![GitHub contributors](https://img.shields.io/github/contributors/kaiiyer/awesome-vulnerable.svg)](https://GitHub.com/kaiiyer/awesome-vulnerable/graphs/contributors/) ⭐ 1,392 | 🐛 2 | 📅 2026-06-22
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,881 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-16 - An Open Source platform for testing Web-Application Security skills. The application contains a vast number of hacking challenges of varying difficulty level
* [OWASP WebGoat8](https://github.com/webgoat/webgoat) ⭐ 9,339 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-14 - OWASP Webgoat 8 is a learning platform that attempts to teach about common web security flaws. It contains generic security flaws that apply to most web applications, is written in Java and is actively maintained.
* [sqli-labs](https://github.com/Audi-1/sqli-labs) ⭐ 5,844 | 🐛 33 | 🌐 PHP | 📅 2023-12-11 - SQLI labs to test error based, Blind boolean based, Time based.
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat.git) ⭐ 3,730 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
...
* [NOWASP / Mutillidae 2](https://github.com/webpwnized/mutillidae) ⭐ 1,521 | 🐛 1 | 🌐 PHP | 📅 2026-06-22 - OWASP Mutillidae II is a free, open source, deliberately vulnerable web-application providing a target for web-security enthusiast.
...
* [tegal1337/0l4bs](https://github.com/tegal1337/0l4bs) ⭐ 347 | 🐛 1 | 🌐 PHP | 📅 2021-06-02 - Cross-site scripting (XSS) labs for web application security enthusiasts
...
* [Damn Vulnerable Cloud Application](https://github.com/m6a-UdS/dvca.git) ⭐ 212 | 🐛 0 | 🌐 CSS | 📅 2018-09-12 - Damn Vulnerable Cloud Application
...
* [Commix](https://github.com/stasinopoulos/commix-testbed) ⭐ 182 | 🐛 0 | 🌐 PHP | 📅 2026-09-14 - A collection of web pages, vulnerable to command injection flaws.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 44 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-13 - An open-source, intentionally vulnerable e-commerce application built with Next.js and React. Provides a realistic CTF platform for learning web application security testing. Can be quickly set up using `npx create-oss-store`.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,840 | 🐛 426 | 🌐 Python | 📅 2026-09-07 - CTFs as you need them
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,784 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - The Kubernetes Goat designed to be intentionally vulnerable cluster environment to learn and practice Kubernetes security.
...
* [NightShade](https://github.com/UnrealAkama/NightShade) ⭐ 128 | 🐛 7 | 🌐 JavaScript | 📅 2017-05-28 - A simple capture the flag framework.
...
* [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,184 | 🐛 238 | 🌐 Python | 📅 2026-09-14 - A set of mobile apps that help you to improve your reverse engineering skills base don the [OWASP MSTG](https://github.com/OWASP/owasp-mstg) ⭐ 13,184 | 🐛 238 | 🌐 Python | 📅 2026-09-14.
...
* [Allsafe](https://github.com/t0thkr1s/allsafe) ⭐ 430 | 🐛 2 | 🌐 Java | 📅 2025-09-20 - Allsafe is an intentionally vulnerable application that contains various vulnerabilities.
...
* [OWASP crAPI](https://github.com/OWASP/crAPI) ⭐ 1,582 | 🐛 30 | 🌐 Java | 📅 2026-09-09 - crAPI stands for “Completely Ridiculous API”. It simulates an API-driven, microservice-based web application that is a platform for vehicle owners. crAPI specializes in the common vulnerabilities that happen in modern API-based applications, including all those in the OWASP Top 10 for APIs.
* [VAmPI](https://github.com/erev0s/VAmPI) ⭐ 1,326 | 🐛 4 | 🌐 Python | 📅 2026-04-07 - VAmPI is a vulnerable API made with Flask and it includes vulnerabilities from the OWASP top 10 vulnerabilities for APIs.
...
* [capital](https://github.com/Checkmarx/capital) ⭐ 338 | 🐛 18 | 🌐 CSS | 📅 2026-06-10 - A built-to-be-vulnerable API application based on the OWASP top 10 API vulnerabilities. Use c{api}tal to learn, train and exploit API Security vulnerabilities within your own API Security CTF.
