...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 498,568 | 🐛 105 | 📅 2026-08-21
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,704 | 🐛 4 | 🌐 TypeScript | 📅 2026-08-21 - An Open Source platform for testing Web-Application Security skills. The application contains a vast number of hacking challenges of varying difficulty level
* [OWASP WebGoat8](https://github.com/webgoat/webgoat) ⭐ 9,285 | 🐛 35 | 🌐 JavaScript | 📅 2026-08-14 - OWASP Webgoat 8 is a learning platform that attempts to teach about common web security flaws. It contains generic security flaws that apply to most web applications, is written in Java and is actively maintained.
...
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat.git) ⭐ 3,702 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
...
* [NOWASP / Mutillidae 2](https://github.com/webpwnized/mutillidae) ⭐ 1,512 | 🐛 1 | 🌐 PHP | 📅 2026-06-22 - OWASP Mutillidae II is a free, open source, deliberately vulnerable web-application providing a target for web-security enthusiast.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 40 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-18 - An open-source, intentionally vulnerable e-commerce application built with Next.js and React. Provides a realistic CTF platform for learning web application security testing. Can be quickly set up using `npx create-oss-store`.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,797 | 🐛 425 | 🌐 Python | 📅 2026-08-19 - CTFs as you need them
...
* [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,125 | 🐛 233 | 🌐 Python | 📅 2026-08-14 - A set of mobile apps that help you to improve your reverse engineering skills base don the [OWASP MSTG](https://github.com/OWASP/owasp-mstg) ⭐ 13,125 | 🐛 233 | 🌐 Python | 📅 2026-08-14.
...
* [OWASP crAPI](https://github.com/OWASP/crAPI) ⭐ 1,564 | 🐛 31 | 🌐 Java | 📅 2026-05-14 - crAPI stands for “Completely Ridiculous API”. It simulates an API-driven, microservice-based web application that is a platform for vehicle owners. crAPI specializes in the common vulnerabilities that happen in modern API-based applications, including all those in the OWASP Top 10 for APIs.
* [VAmPI](https://github.com/erev0s/VAmPI) ⭐ 1,306 | 🐛 4 | 🌐 Python | 📅 2026-04-07 - VAmPI is a vulnerable API made with Flask and it includes vulnerabilities from the OWASP top 10 vulnerabilities for APIs.
