...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,804 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-07 - An Open Source platform for testing Web-Application Security skills. The application contains a vast number of hacking challenges of varying difficulty level
* [OWASP WebGoat8](https://github.com/webgoat/webgoat) ⭐ 9,321 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-07 - OWASP Webgoat 8 is a learning platform that attempts to teach about common web security flaws. It contains generic security flaws that apply to most web applications, is written in Java and is actively maintained.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,826 | 🐛 426 | 🌐 Python | 📅 2026-09-07 - CTFs as you need them
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,772 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - The Kubernetes Goat designed to be intentionally vulnerable cluster environment to learn and practice Kubernetes security.
...
* [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,158 | 🐛 238 | 🌐 Python | 📅 2026-09-07 - A set of mobile apps that help you to improve your reverse engineering skills base don the [OWASP MSTG](https://github.com/OWASP/owasp-mstg) ⭐ 13,158 | 🐛 238 | 🌐 Python | 📅 2026-09-07.
