...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,699 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-10 - An Open Source platform for testing Web-Application Security skills. The application contains a vast number of hacking challenges of varying difficulty level
...
* [sqli-labs](https://github.com/Audi-1/sqli-labs) ⭐ 5,832 | 🐛 33 | 🌐 PHP | 📅 2023-12-11 - SQLI labs to test error based, Blind boolean based, Time based.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 39 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-18 - An open-source, intentionally vulnerable e-commerce application built with Next.js and React. Provides a realistic CTF platform for learning web application security testing. Can be quickly set up using `npx create-oss-store`.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,795 | 🐛 424 | 🌐 Python | 📅 2026-08-19 - CTFs as you need them
...
* [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,123 | 🐛 233 | 🌐 Python | 📅 2026-08-14 - A set of mobile apps that help you to improve your reverse engineering skills base don the [OWASP MSTG](https://github.com/OWASP/owasp-mstg) ⭐ 13,123 | 🐛 233 | 🌐 Python | 📅 2026-08-14.
