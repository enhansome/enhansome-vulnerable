...
[![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 507,117 | 🐛 106 | 📅 2026-09-02
...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,888 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-16 - An Open Source platform for testing Web-Application Security skills. The application contains a vast number of hacking challenges of varying difficulty level
* [OWASP WebGoat8](https://github.com/webgoat/webgoat) ⭐ 9,340 | 🐛 37 | 🌐 JavaScript | 📅 2026-09-14 - OWASP Webgoat 8 is a learning platform that attempts to teach about common web security flaws. It contains generic security flaws that apply to most web applications, is written in Java and is actively maintained.
* [sqli-labs](https://github.com/Audi-1/sqli-labs) ⭐ 5,845 | 🐛 33 | 🌐 PHP | 📅 2023-12-11 - SQLI labs to test error based, Blind boolean based, Time based.
* [CloudGoat](https://github.com/RhinoSecurityLabs/cloudgoat.git) ⭐ 3,731 | 🐛 23 | 🌐 Python | 📅 2026-04-28 - CloudGoat is Rhino Security Labs' "Vulnerable by Design" AWS deployment tool
...
* [NOWASP / Mutillidae 2](https://github.com/webpwnized/mutillidae) ⭐ 1,522 | 🐛 1 | 🌐 PHP | 📅 2026-06-22 - OWASP Mutillidae II is a free, open source, deliberately vulnerable web-application providing a target for web-security enthusiast.
...
* [OSS – OopsSec Store](https://github.com/kOaDT/oss-oopssec-store) ⭐ 45 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-13 - An open-source, intentionally vulnerable e-commerce application built with Next.js and React. Provides a realistic CTF platform for learning web application security testing. Can be quickly set up using `npx create-oss-store`.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,841 | 🐛 426 | 🌐 Python | 📅 2026-09-07 - CTFs as you need them
* [Kubernetes Goat](https://github.com/madhuakula/kubernetes-goat) ⭐ 5,786 | 🐛 28 | 🌐 HTML | 📅 2026-04-16 - The Kubernetes Goat designed to be intentionally vulnerable cluster environment to learn and practice Kubernetes security.
...
* [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,184 | 🐛 236 | 🌐 Python | 📅 2026-09-17 - A set of mobile apps that help you to improve your reverse engineering skills base don the [OWASP MSTG](https://github.com/OWASP/owasp-mstg) ⭐ 13,184 | 🐛 236 | 🌐 Python | 📅 2026-09-17.
...
* [Allsafe](https://github.com/t0thkr1s/allsafe) ⭐ 432 | 🐛 2 | 🌐 Java | 📅 2025-09-20 - Allsafe is an intentionally vulnerable application that contains various vulnerabilities.
