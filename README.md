...
* [OWASP Juice Shop](https://github.com/juice-shop/juice-shop) ⭐ 13,924 | 🐛 10 | 🌐 TypeScript | 📅 2026-09-22 - An Open Source platform for testing Web-Application Security skills. The application contains a vast number of hacking challenges of varying difficulty level
* [OWASP WebGoat8](https://github.com/webgoat/webgoat) ⭐ 9,346 | 🐛 35 | 🌐 JavaScript | 📅 2026-09-22 - OWASP Webgoat 8 is a learning platform that attempts to teach about common web security flaws. It contains generic security flaws that apply to most web applications, is written in Java and is actively maintained.
* [sqli-labs](https://github.com/Audi-1/sqli-labs) ⭐ 5,848 | 🐛 33 | 🌐 PHP | 📅 2023-12-11 - SQLI labs to test error based, Blind boolean based, Time based.
...
* [CTFd](https://github.com/isislab/CTFd) ⭐ 6,845 | 🐛 428 | 🌐 Python | 📅 2026-09-17 - CTFs as you need them
...
* [OWASP MSTG Crackmes](https://github.com/OWASP/owasp-mstg/tree/master/Crackmes) ⭐ 13,195 | 🐛 240 | 🌐 Python | 📅 2026-09-20 - A set of mobile apps that help you to improve your reverse engineering skills base don the [OWASP MSTG](https://github.com/OWASP/owasp-mstg) ⭐ 13,195 | 🐛 240 | 🌐 Python | 📅 2026-09-20.
